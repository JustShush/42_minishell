...
SRC_pipex = ms_pipex.c

lib = libft
LIB = $(lib)/libft.a

OBJ_DIR = obj
SRCS = $(addprefix src/, $(SRC)) $(addprefix src/Other/, $(SRC_other)) $(addprefix src/Parser/, $(SRC_parser)) $(addprefix src/Utils/, $(SRC_utils)) $(addprefix src/BuiltIn/, $(SRC_builtin)) $(addprefix src/replacer/, $(SRC_replacer)) $(addprefix src/pipex/, $(SRC_pipex))
OBJS = $(addprefix $(OBJ_DIR)/, $(SRC:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_other:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_parser:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_utils:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_builtin:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_replacer:%.c=%.o)) $(addprefix $(OBJ_DIR)/, $(SRC_pipex:%.c=%.o))
