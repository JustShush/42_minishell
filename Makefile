...
SRC_utils = arr_utils.c check_cmd.c cmd_utils.c cmd_utils2.c error.c error1.c free2.c inits.c quotes_utils.c rm_quotes.c str_utils.c
...
val:
	@valgrind --leak-check=full --track-origins=yes --show-leak-kinds=all --suppressions=readline.supp --log-file="val_log.txt"   ./minishell
# --trace-children=yes
