...
/*   Updated: 2024/02/07 12:04:39 by dimarque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @note If 'list' is provided, the function also populates it with the substrings found in 'str'
 * @warning If 'list' is provided, ensure it has enough space to store all the substrings
 */
